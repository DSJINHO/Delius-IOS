//
//  Group2MatchViewController.swift
//  Delius
//
...
import UIKit
class Group2MatchViewController:UIViewController{
    var contentView:Group2MatchView!
    ...
    private func setView(){
        contentView = Group2MatchView(frame: view.bounds)
