...
import UIKit
class WaitGroup2ProfileVC:UIViewController{
    var contentView:WaitGroup2ProfileView!
    ...
    private func setup(){
        contentView = WaitGroup2ProfileView(frame: view.bounds)
...
extension WaitGroup2ProfileVC:UICollectionViewDelegate{
    
}
extension WaitGroup2ProfileVC:UICollectionViewDelegateFlowLayout,UICollectionViewDataSource{
