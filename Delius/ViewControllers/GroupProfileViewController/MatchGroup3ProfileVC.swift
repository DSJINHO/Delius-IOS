...
import UIKit
class MatchGroup3ProfileVC:UIViewController{
    var contentView:MatchGroup3ProfileView!
    ...
    private func setup(){
        contentView = MatchGroup3ProfileView(frame: view.bounds)
...
extension MatchGroup3ProfileVC:UICollectionViewDelegate{
    
}
extension MatchGroup3ProfileVC:UICollectionViewDelegateFlowLayout,UICollectionViewDataSource{
