...
import UIKit
class MatchGroup4ProfileVC:UIViewController{
    var contentView:MatchGroup4ProfileView!
    ...
    private func setup(){
        contentView = MatchGroup4ProfileView(frame: view.bounds)
        ...
        contentView.imgCollectionView.register(Tab0GroupImageCell.self, forCellWithReuseIdentifier: "MatchGroupProfileCellid")
        contentView.tagCollectionView.register(MainTagCell.self, forCellWithReuseIdentifier: "MatchGroupProfileTagCellid")
...
extension MatchGroup4ProfileVC:UICollectionViewDelegate{
    
}
extension MatchGroup4ProfileVC:UICollectionViewDelegateFlowLayout,UICollectionViewDataSource{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        if collectionView == contentView.imgCollectionView{
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "MatchGroupProfileCellid", for: indexPath) as! Tab0GroupImageCell
            let url = imgUrls[indexPath.row]
            cell.imgView.sd_setImage(with: url)
            return cell
        }else{
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "MatchGroupProfileTagCellid", for: indexPath) as! MainTagCell
