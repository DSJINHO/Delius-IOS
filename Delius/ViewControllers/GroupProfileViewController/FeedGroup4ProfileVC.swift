...
import UIKit
class FeedGroup4ProfileVC:UIViewController{
    var contentView:FeedGroup4ProfileView!
    ...
    private func setup(){
        contentView = FeedGroup4ProfileView(frame: view.bounds)
...
extension FeedGroup4ProfileVC:UICollectionViewDelegate{
    
}
extension FeedGroup4ProfileVC:UICollectionViewDelegateFlowLayout,UICollectionViewDataSource{
