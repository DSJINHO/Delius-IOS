...
import UIKit
class WaitGroupProfileVC:UIViewController{
    
    var contentView:WaitGroupProfileView!
    ...
    private func setup(){
        contentView = WaitGroupProfileView(frame:view.bounds)
        ...
        contentView.imgCollectionView.register(Tab0GroupImageFirstCell2.self, forCellWithReuseIdentifier: "WaitGroup2ProfileCellid")
        contentView.imgCollectionView.register(Tab0GroupImageFirstCell3.self, forCellWithReuseIdentifier: "WaitGroup3ProfileCellid")
        contentView.imgCollectionView.register(Tab0GroupImageFirstCell4.self, forCellWithReuseIdentifier: "WaitGroup4ProfileCellid")
...
extension WaitGroupProfileVC:UICollectionViewDelegate{
    
}
extension WaitGroupProfileVC:UICollectionViewDelegateFlowLayout,UICollectionViewDataSource{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        if collectionView == contentView.imgCollectionView{
            ...
            let cell2 = collectionView.dequeueReusableCell(withReuseIdentifier: "WaitGroup2ProfileCellid", for: indexPath) as! Tab0GroupImageFirstCell2
            let cell3 = collectionView.dequeueReusableCell(withReuseIdentifier: "WaitGroup3ProfileCellid", for: indexPath) as! Tab0GroupImageFirstCell3
            let cell4 = collectionView.dequeueReusableCell(withReuseIdentifier: "WaitGroup4ProfileCellid", for: indexPath) as! Tab0GroupImageFirstCell4
