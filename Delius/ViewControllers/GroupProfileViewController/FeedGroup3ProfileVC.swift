...
import UIKit
class FeedGroup3ProfileVC:UIViewController{
    var contentView:FeedGroup3ProfileView!
    ...
    private func setup(){
        contentView = FeedGroup3ProfileView(frame: view.bounds)
...
extension FeedGroup3ProfileVC:UICollectionViewDelegate{
    
}
extension FeedGroup3ProfileVC:UICollectionViewDelegateFlowLayout,UICollectionViewDataSource{
