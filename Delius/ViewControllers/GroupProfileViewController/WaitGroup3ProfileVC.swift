...
import UIKit
class WaitGroup3ProfileVC:UIViewController{
    
    var contentView:WaitGroup3ProfileView!
    ...
    private func setup(){
        contentView = WaitGroup3ProfileView(frame: view.bounds)
...
extension WaitGroup3ProfileVC:UICollectionViewDelegate{
    
}
extension WaitGroup3ProfileVC:UICollectionViewDelegateFlowLayout,UICollectionViewDataSource{
