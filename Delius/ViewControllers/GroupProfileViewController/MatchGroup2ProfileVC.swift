...
import UIKit
class MatchGroup2ProfileVC:UIViewController{
    var contentView:MatchGroup2ProfileView!
    ...
    private func setup(){
        contentView = MatchGroup2ProfileView(frame: view.bounds)
...
extension MatchGroup2ProfileVC:UICollectionViewDelegate{
    
}
extension MatchGroup2ProfileVC:UICollectionViewDelegateFlowLayout,UICollectionViewDataSource{
