...
import UIKit
class MainTagCellLayout: UICollectionViewFlowLayout {
    
    private let cInterItemSpacing:CGFloat = 2
    private let cLineSpacing:CGFloat = 2
    
    private var itemAttributesCache: Array<UICollectionViewLayoutAttributes> = []
    private var contentSize:CGSize = CGSize.zero
    var delegate:MainTagCellProtocolDelegate?
