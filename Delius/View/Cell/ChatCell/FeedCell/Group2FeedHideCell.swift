...
import UIKit
class Group2FeedHideCell:UICollectionViewCell{
    ...
    private func setup(d:CGFloat){
        ...
        imgView1.rightAnchor.constraint(equalTo: centerXAnchor).isActive = true
        ...
        imgView2.leftAnchor.constraint(equalTo: centerXAnchor).isActive = true
