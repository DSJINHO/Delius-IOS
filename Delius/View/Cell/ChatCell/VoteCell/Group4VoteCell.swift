...
import UIKit
class Group4VoteCell:UICollectionViewCell{
    ...
    override init(frame:CGRect){
        ...
        backView3.layer.cornerRadius = diameter/2
        backView4.layer.cornerRadius = diameter/2
        imgView1.layer.cornerRadius = diameter/2 - 4
        imgView2.layer.cornerRadius = diameter/2 - 4
        imgView3.layer.cornerRadius = diameter/2 - 4
        imgView4.layer.cornerRadius = diameter/2 - 4
        setup(d:diameter)
    }
    private func setup(d:CGFloat){
        ...
        backView3.topAnchor.constraint(equalTo: backView1.topAnchor).isActive = true
        backView3.leftAnchor.constraint(equalTo: backView2.rightAnchor, constant: -10).isActive = true
        backView3.widthAnchor.constraint(equalToConstant: d).isActive = true
        backView3.heightAnchor.constraint(equalToConstant: d).isActive = true
        
        self.addSubview(backView4)
        backView4.topAnchor.constraint(equalTo: backView1.topAnchor).isActive = true
        backView4.leftAnchor.constraint(equalTo: backView3.rightAnchor, constant: -10).isActive = true
        backView4.widthAnchor.constraint(equalToConstant: d).isActive = true
        backView4.heightAnchor.constraint(equalToConstant: d).isActive = true
        ...
        imgView3.topAnchor.constraint(equalTo: backView3.topAnchor, constant: 4).isActive = true
        imgView3.leftAnchor.constraint(equalTo: backView3.leftAnchor,constant: 4).isActive = true
        imgView3.rightAnchor.constraint(equalTo: backView3.rightAnchor, constant: -4).isActive = true
        imgView3.bottomAnchor.constraint(equalTo: backView3.bottomAnchor, constant: -4).isActive = true
        
        backView4.addSubview(imgView4)
        imgView4.topAnchor.constraint(equalTo: backView4.topAnchor, constant: 4).isActive = true
        imgView4.leftAnchor.constraint(equalTo: backView4.leftAnchor, constant: 4).isActive = true
        imgView4.rightAnchor.constraint(equalTo: backView4.rightAnchor, constant: -4).isActive = true
        imgView4.bottomAnchor.constraint(equalTo: backView4.bottomAnchor, constant: -4).isActive = true
