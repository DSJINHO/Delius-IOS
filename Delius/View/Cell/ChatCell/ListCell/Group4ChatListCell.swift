...
//
import UIKit
class Group4ChatListCell:UICollectionViewCell{
    ...
    private func setup(){
        ...
        backView1.leftAnchor.constraint(equalTo: pictureView.leftAnchor,constant: -2).isActive = true
        ...
        pictureView.addSubview(backView4)
        backView4.topAnchor.constraint(equalTo: pictureView.topAnchor, constant: -2).isActive = true
        backView4.rightAnchor.constraint(equalTo: pictureView.rightAnchor,constant: 2).isActive = true
        backView4.widthAnchor.constraint(equalToConstant: wd).isActive = true
        backView4.heightAnchor.constraint(equalToConstant: wd).isActive = true
        ...
        imgView4.topAnchor.constraint(equalTo: backView4.topAnchor,constant:2).isActive = true
        imgView4.leftAnchor.constraint(equalTo: backView4.leftAnchor,constant:2).isActive = true
        imgView4.rightAnchor.constraint(equalTo: backView4.rightAnchor,constant:-2).isActive = true
        imgView4.bottomAnchor.constraint(equalTo: backView4.bottomAnchor,constant:-2).isActive = true
