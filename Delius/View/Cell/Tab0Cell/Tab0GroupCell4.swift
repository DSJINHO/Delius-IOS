...
import UIKit
class Tab0GroupCell4:UICollectionViewCell{
    var opened=false
    var type:Int = 1
    ...
    override init(frame: CGRect) {
        ...
        imgCollectionView.register(Tab0GroupImageCell.self, forCellWithReuseIdentifier: "Tab0GroupImageCell4id")
        ...
        actionAnimator.backgroundColor = .clear
    ...
    var nsCX4,nsCY4,nsW4,nsH4:NSLayoutConstraint!
    ...
    private func setup(width:CGFloat){
        ...
        nsCX3.isActive = true
        nsCY3 = circleView3.centerYAnchor.constraint(equalTo: imgCollectionView.topAnchor, constant: term + param * 4)
        nsCY3.isActive = true
        ...
        nsCX4 = circleView4.centerXAnchor.constraint(equalTo: imgCollectionView.leftAnchor, constant: term + param * 15)
        nsCX4.isActive = true
        nsCY4 = circleView4.centerYAnchor.constraint(equalTo: imgCollectionView.topAnchor, constant: term + param * 15)
        nsCY4.isActive = true
        nsW4 = circleView4.rightAnchor.constraint(equalTo: circleView4.leftAnchor, constant: param * 8)
        nsW4.isActive = true
        nsH4 = circleView4.bottomAnchor.constraint(equalTo: circleView4.topAnchor, constant: param * 8)
        nsH4.isActive = true
        
        circleView1.layer.cornerRadius = param*4
        circleView2.layer.cornerRadius = param*4
        circleView3.layer.cornerRadius = param*4
        circleView4.layer.cornerRadius = param*4
        ...
        imgView4.topAnchor.constraint(equalTo: circleView4.topAnchor, constant: 5).isActive = true
        imgView4.leftAnchor.constraint(equalTo: circleView4.leftAnchor,constant: 5).isActive = true
        imgView4.rightAnchor.constraint(equalTo: circleView4.rightAnchor, constant: -5).isActive = true
        imgView4.bottomAnchor.constraint(equalTo: circleView4.bottomAnchor, constant: -5).isActive = true
        
        imgView1.layer.cornerRadius = param*4 - 5
        imgView2.layer.cornerRadius = param*4 - 5
        imgView3.layer.cornerRadius = param*4 - 5
        imgView4.layer.cornerRadius = param*4 - 5
        ...
        nameLabel4.topAnchor.constraint(equalTo: circleView4.bottomAnchor, constant: 3).isActive = true
        nameLabel4.widthAnchor.constraint(equalToConstant: 200).isActive = true
        nameLabel4.heightAnchor.constraint(equalToConstant: 20).isActive = true
        nameLabel4.centerXAnchor.constraint(equalTo: circleView4.centerXAnchor).isActive = true
...
extension Tab0GroupCell4:UICollectionViewDelegate{

}
extension Tab0GroupCell4:UICollectionViewDelegateFlowLayout,UICollectionViewDataSource,MainTagCellProtocolDelegate,UIScrollViewDelegate{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        if collectionView == tagCollectionView{
            ...
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "Tab0GroupImageCell4id", for: indexPath) as! Tab0GroupImageCell
    ...
    private func imgAnimation(offset:CGFloat){
        ...
        if ratio <= 1 {
            self.nsCX1.constant = d * 6 + term - ratio * ( d * 4)
            self.nsCX2.constant = d * 13 + term - ratio * ( d * 5 )
            self.nsCX3.constant = d * 15 + term - ratio * (d * 1)
            self.nsCX4.constant = d * 17 + term
            self.nsCY1.constant = d * 10 + term
            self.nsCY2.constant = d * 10 + term
            self.nsCY3.constant = d * 10 + term
            ...
            ratio = ratio - 1
            self.nsCX1.constant = d * 2 + term
            self.nsCX2.constant = d * 8 + term - ratio * ( d * 4)
            self.nsCX3.constant = d * 14 + term - ratio * ( d * 4)
            self.nsCX4.constant = d * 17 + term
            self.nsCY1.constant = d * 10 + term
            self.nsCY2.constant = d * 10 + term
            self.nsCY3.constant = d * 10 + term
            ...
            self.nsCX1.constant = d * 2 + term
            self.nsCX2.constant = d * 4 + term
            self.nsCX3.constant = d * 10 + term - ratio * ( d * 4)
            self.nsCX4.constant = d * 17 + term - ratio * ( d * 5)
            self.nsCY1.constant = d * 10 + term
            self.nsCY2.constant = d * 10 + term
            self.nsCY3.constant = d * 10 + term
            self.nsCY4.constant = d * 10 + term
            self.nsW1.constant = d * 4
            self.nsW2.constant = d * 4
            self.nsW3.constant = d * 12 - ratio * ( d * 8)
            self.nsW4.constant = d * 4 + ratio * ( d * 8)
            self.nsH1.constant = d * 4
            self.nsH2.constant = d * 4
            self.nsH3.constant = d * 12 - ratio * ( d * 8)
            self.nsH4.constant = d * 4 + ratio * ( d * 8)
            self.nameLabel1.alpha = 0
            self.nameLabel2.alpha = 0
            self.nameLabel3.alpha = 1 - ratio
            self.nameLabel4.alpha = ratio
            self.circleView1.layer.cornerRadius = d * 2
            self.circleView2.layer.cornerRadius = d * 2
            self.circleView3.layer.cornerRadius = d * 6 - ratio * ( d * 4)
            self.circleView4.layer.cornerRadius = d * 2 + ratio * ( d * 4)
            self.imgView1.layer.cornerRadius = d*2 - 5
            self.imgView2.layer.cornerRadius = d*2 - 5
            self.imgView3.layer.cornerRadius = d*6 - 5 - ratio * ( d * 4)
            self.imgView4.layer.cornerRadius = d*2 - 5 + ratio * ( d * 4)
            return
        }
    }
}
