...
import UIKit
class Tab0GroupCell3:UICollectionViewCell{
    var opened=false
    var type:Int = 1
...
extension Tab0GroupCell3:UICollectionViewDelegate{

}
extension Tab0GroupCell3:UICollectionViewDelegateFlowLayout,UICollectionViewDataSource,MainTagCellProtocolDelegate,UIScrollViewDelegate{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        if collectionView == tagCollectionView{
            ...
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "Tab0GroupImageCell3id", for: indexPath) as! Tab0GroupImageCell
