...
class MenuGroup4Cell:UICollectionViewCell{
    ...
    private func setup(){
        ...
        imgView4.topAnchor.constraint(equalTo: imgView3.topAnchor).isActive = true
        imgView4.leftAnchor.constraint(equalTo: imgView3.rightAnchor,constant: -10).isActive = true
