...
import UIKit
class PushFeedGroup2HideView:UIView{
    ...
    override init(frame:CGRect){
        ...
        gView = MainGradientView(frame: CGRect(x: 0, y: 0, width: self.frame.width - 40, height: 50))
        setup()
    }
    private func setup(){
        ...
        titleLabel.leftAnchor.constraint(equalTo: circleView2.rightAnchor, constant: 15).isActive = true
