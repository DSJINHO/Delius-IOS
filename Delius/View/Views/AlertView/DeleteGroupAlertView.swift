...
import UIKit
class DeleteGroupAlertView:UIView{
    ...
    let imgView:UIImageView={
        ...
        v.image = UIImage(named: "TrashBin")
        return v
    }()
    ...
    private func setup(){
        ...
        whiteView.heightAnchor.constraint(equalToConstant: 270).isActive = true
