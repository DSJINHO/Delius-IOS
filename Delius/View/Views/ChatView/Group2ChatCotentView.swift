...
import UIKit
class Group2ChatContentView:UIView{
...
//        layout.headerReferenceSize = CGSize(width: 0, height: 30)
    ...
    private func setup(){
        ...
        circleView1.rightAnchor.constraint(equalTo: topView.centerXAnchor, constant: 3).isActive = true
        ...
        circleView2.leftAnchor.constraint(equalTo: topView.centerXAnchor, constant: -3).isActive = true
        ...
        profileTapView.rightAnchor.constraint(equalTo: circleView2.rightAnchor).isActive = true
