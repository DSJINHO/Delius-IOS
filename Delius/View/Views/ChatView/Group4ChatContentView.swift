...
import UIKit
class Group4ChatContentView:UIView{
...
//        layout.headerReferenceSize = CGSize(width: 0, height: 30)
    ...
    private func setup(){
        ...
        circleView2.rightAnchor.constraint(equalTo: topView.centerXAnchor, constant: 3).isActive = true
        ...
        circleView1.centerYAnchor.constraint(equalTo: backBtn.centerYAnchor).isActive = true
        
        topView.addSubview(circleView3)
        circleView3.centerYAnchor.constraint(equalTo: backBtn.centerYAnchor).isActive = true
        ...
        circleView3.leftAnchor.constraint(equalTo: topView.centerXAnchor, constant: -3).isActive = true
        
        topView.addSubview(circleView4)
        circleView4.leftAnchor.constraint(equalTo: circleView3.rightAnchor, constant: -6).isActive = true
        circleView4.heightAnchor.constraint(equalToConstant: 44).isActive = true
        circleView4.widthAnchor.constraint(equalToConstant: 44).isActive = true
        circleView4.centerYAnchor.constraint(equalTo: backBtn.centerYAnchor).isActive = true
        ...
        imgView1.leftAnchor.constraint(equalTo: circleView4.leftAnchor, constant: 2).isActive = true
        imgView1.rightAnchor.constraint(equalTo: circleView4.rightAnchor, constant: -2).isActive = true
        imgView1.bottomAnchor.constraint(equalTo: circleView4.bottomAnchor, constant: -2).isActive = true
        ...
        profileTapView.rightAnchor.constraint(equalTo: circleView4.rightAnchor).isActive = true
