...
import UIKit
class SoloProfileDetailView:UIView{
    ...
    var unCheckDeli:UIImageView={
        let v = UIImageView()
        v.translatesAutoresizingMaskIntoConstraints = false
        v.backgroundColor = UIColor.clear
        v.image = UIImage(named: "MainUnCheckDeli")
        v.contentMode = .scaleAspectFit
        v.tintColor = UIColor.MainLightGrayColor()
        return v
    }()
    var unCheckLike:UIImageView={
        let v = UIImageView()
        v.translatesAutoresizingMaskIntoConstraints = false
        v.backgroundColor = UIColor.clear
        v.image = UIImage(named: "MainUnCheckLike")
        v.contentMode = .scaleAspectFit
        v.tintColor = UIColor.MainLightGrayColor()
        return v
    }()
    ...
    override init(frame:CGRect){
        ...
        btnView = MainGradientView(frame: CGRect(x:0,y:0,width:frame.width - 60 - 3*d,height:60))
        
        
        closeBtn = MainActionButton(imgName: "MainReport", color: .white, frame: btnFrame)
        editBtn = MainActionButton(imgName: "ProfileEdit", color: .white, frame: btnFrame)
    ...
    private func setup(width:CGFloat,d:CGFloat){
        ...
        scrollView.addSubview(unCheckLike)
        unCheckLike.centerYAnchor.constraint(equalTo: nameLabel.centerYAnchor).isActive = true
        unCheckLike.rightAnchor.constraint(equalTo: nameLabel.rightAnchor).isActive = true
        unCheckLike.widthAnchor.constraint(equalToConstant: 20).isActive = true
        unCheckLike.heightAnchor.constraint(equalToConstant: 20).isActive = true
        
        scrollView.addSubview(unCheckDeli)
        unCheckDeli.centerYAnchor.constraint(equalTo: nameLabel.centerYAnchor).isActive = true
        unCheckDeli.rightAnchor.constraint(equalTo: unCheckLike.leftAnchor, constant: -10).isActive = true
        unCheckDeli.widthAnchor.constraint(equalToConstant: 20).isActive = true
        unCheckDeli.heightAnchor.constraint(equalToConstant: 20).isActive = true
        ...
        btnView.widthAnchor.constraint(equalToConstant: 2*d).isActive = true
        ...
        editBtn.centerYAnchor.constraint(equalTo: btnView.centerYAnchor).isActive = true
        editBtn.widthAnchor.constraint(equalToConstant: d).isActive = true
        editBtn.heightAnchor.constraint(equalToConstant: d).isActive = true
        editBtn.leftAnchor.constraint(equalTo: btnView.leftAnchor).isActive = true
...
extension SoloProfileDetailView:MainTagCellProtocolDelegate{
...
extension SoloProfileDetailView:UIScrollViewDelegate{
