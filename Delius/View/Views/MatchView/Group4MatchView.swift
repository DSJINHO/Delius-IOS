...
class Group4MatchView:UIView{
    ...
    private func setup(){
        ...
        backImgView2.bottomAnchor.constraint(equalTo: centerYAnchor).isActive = true
        ...
        backImgView3.topAnchor.constraint(equalTo: centerYAnchor).isActive = true
        ...
        self.addSubview(backImgView4)
        backImgView4.bottomAnchor.constraint(equalTo: bottomAnchor).isActive = true
        backImgView4.leftAnchor.constraint(equalTo: leftAnchor).isActive = true
        backImgView4.rightAnchor.constraint(equalTo: rightAnchor).isActive = true
        backImgView4.heightAnchor.constraint(equalToConstant: height).isActive = true
