...
class Group2MatchView:UIView{
    ...
    private func setup(){
        ...
        backImgView1.bottomAnchor.constraint(equalTo: centerYAnchor).isActive = true
        
        self.addSubview(backImgView2)
        backImgView2.topAnchor.constraint(equalTo: centerYAnchor).isActive = true
        ...
        backImgView2.bottomAnchor.constraint(equalTo: bottomAnchor).isActive = true
