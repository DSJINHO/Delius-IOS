...
import UIKit
class PurchaseBoosterView:UIView{
    ...
    var gView:BoosterGradationView!
    ...
    var purchaseBtn:UIButton={
        ...
        b.setTitle("PurchaseBoosterString201".localize(), for: .normal)
        return b
    }()
    var subLabel:UILabel={
        ...
        l.text = "PurchaseBoosterString301".localize()
        return l
    }()
    ...
    private func setup(){
        ...
        gView = BoosterGradationView(frame: CGRect(x: 0, y: 0, width: self.frame.width-60, height: 100))
        ...
        let btnGraView = PurchaseGradationView(frame: CGRect(x: 0, y: 0, width: self.frame.width-140, height: 50), startColor: UIColor.purpleType1(), endColor: UIColor.purpleType2())
    ...
    private func createImgView(){
        let v = UIImageView()
        v.image = UIImage(named: "PurchaseBoosterType")
