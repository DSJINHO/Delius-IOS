...
class GroupFilterView:UIView{
    ...
    let sexLabel:UILabel={
        let l = UILabel()
        l.DeliusLabel(txt: "GroupFilterView002".localize(), txtAlignment: .left, ft: UIFont.DeliusBoldType6(), txtColor: UIColor.MainGrayColor())
        return l
    }()
    let ageLabel:UILabel={
        let l = UILabel()
        l.DeliusLabel(txt: "GroupFilterView003".localize(), txtAlignment: .left, ft: UIFont.DeliusBoldType6(), txtColor: UIColor.MainGrayColor())
        return l
    }()
    let distanceLabel:UILabel={
        let l = UILabel()
        l.DeliusLabel(txt: "GroupFilterView004".localize(), txtAlignment: .left, ft: UIFont.DeliusBoldType6(), txtColor: UIColor.MainGrayColor())
        return l
    }()
    let infoLabel1:UILabel={
        let l = UILabel()
        l.DeliusLabel(txt: "GroupFilterView005".localize(), txtAlignment: .left, ft: UIFont.DeliusBoldType6(), txtColor: UIColor.MainGrayColor())
        return l
    }()
    let infoLabel2:UILabel={
        let l = UILabel()
        l.DeliusLabel(txt: "GroupFilterView006".localize(), txtAlignment: .left, ft: UIFont.DeliusBoldType6(), txtColor: UIColor.MainGrayColor())
        return l
    }()
    let infoLabel3:UILabel={
        let l = UILabel()
        l.DeliusLabel(txt: "GroupFilterView007".localize(), txtAlignment: .left, ft: UIFont.DeliusBoldType6(), txtColor: UIColor.MainGrayColor())
        return l
    }()
    let locationLabel:UILabel={
        let l = UILabel()
        l.DeliusLabel(txt: "GroupFilterView008".localize(), txtAlignment: .left, ft: UIFont.DeliusBoldType6(), txtColor: UIColor.MainGrayColor())
        return l
    }()
    ...
    override init(frame:CGRect){
        ...
        manBtn = FilterCheckButton(txt: "GroupFilterView101".localize(), frame: sexBtnFrame)
        womanBtn = FilterCheckButton(txt:"GroupFilterView102".localize(),frame:sexBtnFrame)
        bothBtn = FilterCheckButton(txt:"GroupFilterView103".localize(),frame:sexBtnFrame)
        currentLocationBtn = FilterCheckButton(txt:"GroupFilterView201".localize(),frame:locationBtnFrame)
        otherLocationBtn = FilterCheckButton(txt:"GroupFilterView202".localize(),frame:locationBtnFrame)
    ...
    private func setup(width:CGFloat,titleHeight h:CGFloat,margin m:CGFloat,term t1:CGFloat,t2:CGFloat){
        ...
        locationLabel.topAnchor.constraint(equalTo: info3CollectionView.bottomAnchor, constant: t2).isActive = true
    ...
    @objc func ageSliderFunc(_ sender:UIControl){
        let lowerStr = String(ageSlider.lowerValue)
        let upperStr = String(ageSlider.upperValue)
        ageSettingLabel.text = lowerStr + "~" + upperStr
    }
    @objc func distanceSliderFunc(_ sender:UIControl){
        let str = String(distanceSlider.upperValue)
        distanceSettingLabel.text = str+"km"
    }
    @objc func boolBtnFunc(_ sender:UIButton){
        
    }
}
extension GroupFilterView:MainTagCellProtocolDelegate{
    func collectionView(_ collectionView: UICollectionView, itemSizeAt indexPath: NSIndexPath) -> CGSize {
        switch collectionView{
        case info1CollectionView:
            let title = String.GroupInfo1Array()[indexPath.row]//tagArray[indexPath.row]
        ...
        case info2CollectionView:
            let title = String.GroupInfo2Array()[indexPath.row]//tagArray[indexPath.row]
            var size = title.size(withAttributes: [NSAttributedString.Key.font: UIFont.systemFont(ofSize: 12)])
            size.width = CGFloat(ceilf(Float(size.width + CGFloat(38))))
            size.height = 30
            if size.width > collectionView.frame.size.width {
        ...
        case info3CollectionView:
            let title = String.GroupInfo3Array()[indexPath.row]//tagArray[indexPath.row]
            var size = title.size(withAttributes: [NSAttributedString.Key.font: UIFont.systemFont(ofSize: 12)])
            size.width = CGFloat(ceilf(Float(size.width + CGFloat(38))))
            size.height = 30
            if size.width > collectionView.frame.size.width {
