...
public class RangeSlider: UIControl {
    ...
    var gapBetweenThumbs: Double {
        return 1 * Double(thumbWidth) * (maximumValue - minimumValue) / Double(bounds.width)
    }
    
    @IBInspectable public var trackTintColor: UIColor = .MainLightGrayColor2() {
        didSet {
            trackLayer.setNeedsDisplay()
        }
    }
    
    @IBInspectable public var trackHighlightTintColor: UIColor = .MainLightGrayColor() {
        didSet {
            trackLayer.setNeedsDisplay()
        }
    }
    
    @IBInspectable public var thumbTintColor: UIColor = .MainGrayColor() {
        didSet {
    ...
    @IBInspectable public var thumbBorderColor: UIColor = .MainGrayColor() {
        didSet {
